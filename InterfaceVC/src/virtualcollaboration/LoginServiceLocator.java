...
public class LoginServiceLocator extends org.apache.axis.client.Service implements virtualcollaboration.LoginService {
    ...
    private java.lang.String Login_address = "http://localhost:8080/virtualCollaboration/services/Login";
    ...
    public virtualcollaboration.Login getLogin(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            virtualcollaboration.LoginSoapBindingStub _stub = new virtualcollaboration.LoginSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (virtualcollaboration.Login.class.isAssignableFrom(serviceEndpointInterface)) {
                virtualcollaboration.LoginSoapBindingStub _stub = new virtualcollaboration.LoginSoapBindingStub(new java.net.URL(Login_address), this);
                _stub.setPortName(getLoginWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://virtualcollaboration", "LoginService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://virtualcollaboration", "Login"));
        }
